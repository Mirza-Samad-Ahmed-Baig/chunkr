...
## [3.0.0](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/compare/v2.1.0...v3.0.0) (2025-06-29)
...
* /health return current version ([627e8c9](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/627e8c9a1160bf4a360f6d0ea0f1376f64344642))
* Added automation of docker build ([#365](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/365)) ([f01cb2f](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/f01cb2fc66c104066f1188149cdbbb8390337169))
...
* Added Open telemetry support for better analytics ([#504](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/504)) ([7baa3d4](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/7baa3d4a03b5bd15c70dd73b00146adf6dfe7ba6))
* Added release please for automated releases ([#363](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/363)) ([d808d4e](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/d808d4e72464b83590dfab73fe973e2f98b4f7e7))
* Added span class instructions for all formula prompts ([#489](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/489)) ([5162f8f](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/5162f8f02fabe8eb0a0f99de1373c5295d3f9ddd))
...
* **core:** Added compatibility to Google AI Studio ([#380](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/380)) ([f56b74c](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/f56b74c23d1bb0faf050c54a74437139dc9a6938))
* **core:** Improved error messages on task failure and retry only failed steps ([#496](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/496)) ([2e09e11](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/2e09e113f8cf0b0950a77c6954cc9ded2e85c434))
...
* **core:** Improved telemetry and added timeout around task processing to deal with long running processes ([#511](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/511)) ([bbe5913](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/bbe59130afffedbf5e2e29267afb1f6300918f67))
...
* Fixed reading of text layer (prevent whitespace inbetween words) ([#461](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/461)) ([8eba7d3](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/8eba7d36d108c736f0d0ca658cf90716c2c0c544))
* Https support for docker compose using nginx ([#434](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/434)) ([868096c](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/868096c8adbb051243e433b2b1c7f440ac1b5997))
* New picture prompts ([#405](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/405)) ([d161fa0](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/d161fa0820fc03ffaf9bdbbf58c124179548a31a))
...
* Updated llm processing pipeline to be more robust ([#527](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/527)) ([1cfb9ca](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/1cfb9ca10801df57175e5ca148852a48cfea54ed))


### Bug Fixes

* Add Default trait implementation to FallbackStrategy enum ([#479](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/479)) ([d9a2eaf](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/d9a2eaf86470d82e8dfed9af874d3cc49ca76ba5))
* Added back segmentation docker with self hosted runner ([0984ba2](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/0984ba2710fca19a807985e5a92fbf1e185bbb03))
* Added file type attributes to span ([#520](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/520)) ([edd7d0d](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/edd7d0d140bd3482ce195e6f2243a9e67b4a5efa))
* Added imagemagick to docker images ([d3ac921](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/d3ac9215f0c570269ba16f3855512da606fd3d4c))
* Added retry when finish reason is length ([#383](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/383)) ([a8dd777](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/a8dd77791d7294e7166a430776a329e53b0a8103))
...
* Compose-cpu web server replicas ([#467](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/467)) ([41b2433](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/41b2433e6ce747c21a0e157e3759b7f1a27ec5ad))
...
* Continue on error on docker build ([aca0b44](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/aca0b4444875a1b053924a60380e6ee44a4dc005))
* **core:** Allow PDFs based on extension if the pages can be counted ([#396](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/396)) ([cfbfd01](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/cfbfd0155f5fcfb6245acc7dbedb1baa0b12df0b))
* **core:** Auto-fix clippy warnings ([#386](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/386)) ([ccb56f9](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/ccb56f95212e5840d931893929c6dec648123e34))
* **core:** Auto-fix clippy warnings ([#393](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/393)) ([0605227](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/06052278229f0fe1c6feec44172e9048bf09ecc1))
* **core:** Auto-fix clippy warnings ([#497](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/497)) ([8469ddf](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/8469ddf179709c40949965be203259231bf6b950))
* **core:** Auto-fix clippy warnings ([#507](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/507)) ([a8c2e70](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/a8c2e70fd5db6503fb38273b611fb7ea16c00422))
* **core:** Auto-fix clippy warnings ([#512](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/512)) ([d9ecf60](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/d9ecf60f308cfe4607673bec172f8fc04d673135))
* **core:** Auto-fix clippy warnings ([#516](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/516)) ([a938056](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/a938056779debec5357ad54b27bf5f0788382ba3))
...
* **core:** Auto-fix clippy warnings ([#528](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/528)) ([7a972ed](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/7a972edddbecce0fcc10edc53669784f6755de89))
* **core:** Auto-fix clippy warnings ([#541](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/541)) ([00db663](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/00db66361022d5566f281badf327a73724da7922))
* **core:** Handle null started_at values with COALESCE in timeout job ([d068be8](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/d068be82b972a6cd830234448e4bbfe5ebb5245a))
* **core:** Update default generation strategies for Picture and Page segments ([5316485](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/5316485aeec2f923f6fb24f9ab1fcab18e275299))
* Correct Rust lint workflow configuration ([0b1a1eb](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/0b1a1ebdf42a2c22ddfcff52fb7356ebb4216287))
* Debugging please release ([e574177](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/e574177cc28c68e86ab08ac5b83328b393b02bf4))
* Debugging please release with core changes ([558a6f9](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/558a6f9fd86c5d6e53b770dd48909a3a60e7f110))
* Default trait added to chunk processing ([20c6f15](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/20c6f15bf5ef1a538413147103313e65e1223e47))
* Docker builds use root version ([82e1768](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/82e176868e215f550377d9aed91e5b37fd57faba))
* Docker compose files update separately ([15328a2](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/15328a23dfd4399b6a56babb18becd04bf7bdf72))
* Docker compose updated uses pr ([f45abd1](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/f45abd130d4c643c288c3492bb27f6736059dfbf))
* Downgraded cuda version for doctr ([36db353](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/36db353079aaf56fd4613ea13b3c88e7d678e897))
* Fix keycloak tag ([df9efa5](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/df9efa5e212a517020e47d66c3820e62ca87acf2))
* Fixed prompts and retries for LLMs ([#394](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/394)) ([4b31588](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/4b3158889747214abc00ee35c634659491e1c07d))
* Fixed timeout query ([97950e5](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/97950e54aaa9c10cc5ce42f75600603c27d73168))
* Formula prompt selection bug ([#484](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/484)) ([3b0942b](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/3b0942b4745739199aa6a8ef11567f05acf4d4cc))
* Github action now removes v from version before tagging ([6c77a1f](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/6c77a1f5f435c362ec62aabb8bd29a78cc7eba1e))
* Image tag updates not full image ([7b8791f](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/7b8791f6bdee1e2b5f47496936700de4ddaee537))
* Improved error handling and telemetry for segment processing ([#515](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/515)) ([2afc82e](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/2afc82e361387b51a5d5ab5f99cf74978917e9e1))
...
* Only trigger docker build after releases created ([676c280](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/676c280e975ea37a8a737876854b0e3aa7006fc2))
...
* Picture default strategy to LLM as default in the generation strategy for html and markdown ([#524](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/524)) ([e44126c](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/e44126c0387fb176f9ac6b027e3d6d0231102591))
* Release-please docker build ([6e1ff43](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/6e1ff43ad0d5780d2f4a6e67b0b2bcc47d8964f6))
* Removed segmenetation from docker build ([5dc9e6e](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/5dc9e6e5d1687bbe6ab3555f7df5656856a43f34))
...
* Rm extended context default and picture default ([8411eca](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/8411eca5dc9c66833cd431049ada51675d3ce81f))
* Rmeoved changelog from core ([b658a63](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/b658a6373baee8cba156d7272a8c91accda0e0e8))
* Rmeoved changelog from core ([4f7c9c0](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/4f7c9c0595199ae176c883f230713514b889d9a5))
...
* Updated changelog paths ([d20b811](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/d20b8112fc5043f5eecabf1e72e89412b1b5e7b1))
* Updated hashmap to lru for caching ([d868c76](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/d868c76dd16a6751e3baab43190b81e827e26395))
* Updated manual conversion from html to mkd to pandoc ([#539](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/539)) ([16cc847](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/16cc847f5728bd963bf8f367579721098190141c))
...
* Updated rust version ([5fce4c4](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/5fce4c4496dc02954088373b415ba7722ff076be))
* Updated rust version for docker builds ([e5a3633](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/e5a3633e970dacae3ce08e42f5d7249aed592fa6))
...
* Improved llm analytics for extraction errors ([#538](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/issues/538)) ([0302499](https://github.com/Mirza-Samad-Ahmed-Baig/chunkr/commit/0302499f9942c3f2d0f3888ef419d7e2f6945394))
